  ...
  return (
    <section className="relative text-white min-h-[90vh] flex items-center justify-center text-center p-4 pt-32 overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-20 max-w-5xl mx-auto flex flex-col items-center drop-shadow-lg"
      >
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter uppercase mb-8 leading-tight max-w-4xl drop-shadow-xl">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center w-full">
          <Button asChild className="w-full sm:w-auto h-14 px-8 rounded-none bg-primary hover:bg-white hover:text-black text-white uppercase tracking-widest font-bold transition-colors duration-300 shadow-lg">
