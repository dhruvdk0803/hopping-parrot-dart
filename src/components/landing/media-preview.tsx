      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter uppercase mb-6">
            Kingdom Conversations & Official Partners
          </h2>
          <p className="text-lg md:text-xl text-gray-400 mb-12 leading-relaxed">
            Listen to conversations about faith, leadership, community impact, and purpose-driven living with Jeff McCubbins on the Kingdom Conversations podcast. We are also proud to highlight our "Official Partners"—the dedicated partners and businesses, such as Loading Golf and Bridge Integrative Medicine, who help make our mission possible.
          </p>
