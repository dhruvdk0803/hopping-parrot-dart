    ...
    <section className="relative min-h-[100svh] text-white overflow-hidden flex items-center">
      <div className="absolute inset-0 z-0 bg-black overflow-hidden pointer-events-none">
        ...
        */}
        ...
        ></iframe>
        {/* Smooth gradient from black (85%) to transparent */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/70 to-black/90 md:bg-gradient-to-r md:from-black/85 md:to-transparent z-10" />
      </div>
      ...
      <div className="relative z-20 w-full flex flex-col items-center justify-center text-center md:items-start md:text-left container mx-auto px-4 pt-32 pb-24">
        ...
        >
          <h1 className="max-w-[600px] text-[40px] md:text-[64px] font-bold tracking-tighter leading-[1.05] drop-shadow-lg">
          ...
          <motion.div 
            ...
            className="w-16 h-[2px] bg-primary mt-5 origin-center md:origin-left"
          />
          ...
          <motion.p 
            ...
            className="mt-5 max-w-[480px] text-base md:text-lg leading-relaxed text-gray-200 drop-shadow-md"
          >
