...
export function HeroSection() {
  return (
    <section className="relative min-h-[100svh] text-white overflow-hidden flex items-center justify-center">
      ...
      {/* Layered Background Overlays - Lightened */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/40 to-black/70 z-10 pointer-events-none" />
      ...
      <div className="relative z-20 w-full flex flex-col items-center justify-center text-center container mx-auto px-4 pt-32 pb-32">
        <motion.div
          ...
          className="w-full flex flex-col items-center drop-shadow-lg"
        >
          <h1 className="max-w-[700px] mx-auto text-[40px] md:text-[64px] font-bold tracking-tighter leading-[1.05] drop-shadow-xl mb-4">
          ...
          <motion.p 
            ...
            className="max-w-[460px] mx-auto text-base md:text-lg text-gray-100 drop-shadow-xl mb-7 leading-[1.6] font-medium"
          >
          ...
          >
            ...
            <Button 
              asChild 
              variant="outline" 
              className="w-full sm:w-auto rounded-none border-white text-white hover:bg-white hover:text-black hover:border-white uppercase font-semibold py-4 px-8 transition-all duration-300 bg-black/20 backdrop-blur-sm h-auto"
          ...
          <motion.div
            ...
            className="mt-8 flex items-center justify-center gap-4 opacity-90 drop-shadow-md"
          >
            <span className="w-8 h-[1px] bg-white/70 hidden md:block"></span>
            <p className="text-xs sm:text-sm text-white uppercase tracking-widest font-bold">
