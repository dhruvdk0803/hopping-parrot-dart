      ...
      <div className="relative z-20 w-full flex flex-col items-center justify-center text-center container mx-auto px-4 pt-32 pb-32">
        ...
        >
          <h1 className="max-w-[700px] mx-auto text-[40px] md:text-[64px] font-bold tracking-tighter leading-[1.05] drop-shadow-lg">
            ...
            <span className="block text-[32px] md:text-[48px] font-medium text-white/90 mt-2">
          ...
          <motion.div 
            ...
            className="w-16 h-[2px] bg-primary mt-8 mx-auto origin-center"
          />
          ...
          <motion.p 
            ...
            className="mt-8 max-w-[460px] mx-auto text-base md:text-lg leading-loose text-gray-200 drop-shadow-md"
          >
          ...
          >
            <Button asChild size="lg" className="w-full sm:w-auto rounded-none bg-primary hover:bg-primary/90 text-white uppercase tracking-widest font-bold h-14 px-10 transition-all duration-300 shadow-xl hover:scale-[1.02]">
              <Link href="/tournaments">View upcoming Tournaments</Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="w-full sm:w-auto rounded-none border-white text-white hover:bg-white hover:text-black uppercase tracking-widest font-bold h-14 px-10 transition-all duration-300 shadow-lg bg-transparent backdrop-blur-none">
          ...
          <motion.div
            ...
            className="mt-12 flex items-center justify-center gap-4 opacity-80"
          >
