  ...
  return (
    <section className="relative text-white min-h-[80vh] flex items-center justify-center text-center p-4 pt-32 overflow-hidden">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-white mb-6 font-medium max-w-3xl leading-relaxed drop-shadow-md">
        ...
        <p className="text-lg md:text-xl text-white mb-12 font-medium max-w-3xl leading-relaxed drop-shadow-md">
        ...
        <Button asChild className="w-full sm:w-auto h-14 px-10 rounded-none bg-primary hover:bg-white hover:text-black text-white uppercase tracking-widest font-bold transition-colors duration-300 shadow-lg">
